...
/**
 * This class implements base operation of database Class of dao implement
 * should extend it to use these methods
 * 
...
public class SQLAction {
	...
	protected void fillSQLParamter(PreparedStatement stmt, Object... objs)
			throws SQLException {
		if (objs == null) {
	...
	public <T> T queryObject(Connection conn,
			ResultSetProcessor<T> rsProcessor, String sql, Object... params)
			throws SQLException {
		PreparedStatement stmt = null;
		ResultSet rs = null;
		T result = null;
	...
	public <T> T queryObject(ResultSetProcessor<T> rsProcessor, String sql,
	...
	public <T> List<T> queryObjects(Connection conn,
			ResultSetProcessor<T> rsProcessor, String sql, Object... params)
			throws SQLException {
		PreparedStatement stmt = null;
		ResultSet rs = null;
	...
	public List<?> queryObjects(ResultSetProcessor<?> rsProcessor, String sql,
			Object... params) throws SQLException {
		Connection conn = this.getConnection();
		try {
